...
dns_indicator_definition: Der Indikator gibt den wertmäßigen Anteil der Einfuhren <abbr title="beziehungsweise" tabindex="0">bzw.</abbr> Importen aus am wenigsten entwickelten Ländern (Least Developed Countries, <abbr title="Least developed countries (Am wenigsten entwickelte Länder)" tabindex="0">LDCs</abbr>) an den gesamten Einfuhren nach Deutschland an.    
...
data_footnotes: Die Daten basieren auf einer Sonderauswertung.<br>• 2021&nbsp;vorläufige Daten.<br>• <abbr title="Least developed countries (Am wenigsten entwickelte Länder)" tabindex="0">LDC</abbr> = Am wenigsten entwickelte Länder (Least Developed Countries).    
