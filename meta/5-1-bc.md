...
source_organisation_1: '<a href="https://www.fidar.de/" target="_blank" onclick="return confirm_alert('vom Frauen in die Aufsichtsräte e.V.')>Frauen in die Aufsichtsräte e.V.</a>'
source_organisation_1_short: '<a href="https://www.fidar.de/" target="_blank" onclick="return confirm_alert('vom Frauen in die Aufsichtsräte e.V.')>Frauen in die Aufsichtsräte e.V.</a>'
source_organisation_logo_1: '<a href="https://www.fidar.de/" target="_blank" onclick="return confirm_alert('vom Frauen in die Aufsichtsräte e.V.')><img src="www.dnsTestEnvironment.github.io/dns-indicators/public/OrgImgDe/fidar.png" alt="Frauen in die Aufsichtsräte e.V." title=" Klicken Sie hier um zur Homepage der Organisation Frauen in die Aufsichtsräte e.V. zu gelangen." style="height:60px; width:148px; border: transparent"/></a>'
