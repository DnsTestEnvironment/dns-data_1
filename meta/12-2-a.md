...
computation_units: Anzahl der in Deutschland registrierten Organisationen/Standorte sowie deren Beschäftigten, in 1&nbsp;000    
copyright: '&copy; Statistisches Bundesamt (Destatis), 2022'
    
graph_title: Einsatz des Umweltmanagementsystems EMAS    
graph_type: line    
graph_min_value:     
graph_max_value:     
stackedBar:     
