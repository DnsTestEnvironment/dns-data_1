...
<div>
  <div class="my-header">
    <label class="default">a) Material deprivation: keep the proportion below the <abbr title="European Union consisting of 27&nbsp;member states (without United Kingdom)" tabindex="0">EU-27</abbr>-level by 2030
      <a href="https://dnsTestEnvironment.github.io/dns-indicators/en/status"><img src="https://sdg-indikatoren.de/public/Wettersymbole/Bewertung ausgesetzt.png" title="In 2020 the target value was missed and the indicator had not moved towards the target on average over the previous changes." alt="Weathersymbol: Bewertung ausgesetzt"/>
      </a>
    </label>
  </div>
</div>
