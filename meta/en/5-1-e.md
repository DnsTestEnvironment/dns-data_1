...
dns_indicator_definition: The indicator shows the number of women and girls in developing and emerging countries who were reached by vocational qualification measures through German development cooperation. The indicator is divided into financial (FZ) and technical cooperation (TZ).<br>Services from TZ include consulting, to a limited degree the delivery of material goods, the production of facilities and the implementation of studies and reports. FZ provides favourable loans, venture capital or grants, that do not have to be repaid.    
...
source_organisation_logo_3: '<a href="https://ceval.de/modx/enindex.php?id=692" target="_blank"><img src="www.dnsTestEnvironment.github.io/dns-indicators/public/OrgImgEn/ceval.png" alt="CEval GmbH" title=" Click here to visit the homepage of the organizationCEval GmbH" style="height:60px; width:148px; border: transparent"/></a>'
