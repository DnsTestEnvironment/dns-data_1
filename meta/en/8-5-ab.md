...
footer_fields:
  ...
  - series: employment rate, older people (60 to 64-year-olds)
    label: Notes
    value: "<br>• Due to comprehensive redesign of the microcensus it is not possible to compare the data of the survey year 2020&nbsp;with previous years (break in time series).<br>• Länder: The data is based on a special evaluation and is not publicly available.<br>• Bremen: 
- Men 2010&nbsp;limited significance.
- Women 2010&nbsp;to 2012&nbsp;and 2015&nbsp;limited significance.<br>• Saarland: 
- Women 2010&nbsp;limited significance."    
