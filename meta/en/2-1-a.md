...
weather_indicator_1_year_h: 2013
weather_indicator_1_year_i: 2012
...
weather_indicator_1_target_1_item_b: Später
weather_indicator_1_target_1_item_b_title: The assessment will be carried out later.
...
weather_indicator_1_target_1_item_h_title: Although the indicator has in 2013 been moving in the desired direction toward the target, if the trend had to continued, the target would have been missed in the target year by more than 20% of the difference between the target value and the value at that time.
weather_indicator_1_target_1_item_h_valid: true
weather_indicator_1_target_1_item_i: Leicht bewölkt
weather_indicator_1_target_1_item_i_title: If the development from 2012 had continued, the target had been missed by at least 5&nbsp;documentat%, but by a maximum of 20&nbsp;% of the difference between the target value and the value at that time.
