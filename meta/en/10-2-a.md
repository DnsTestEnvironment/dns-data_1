...
data_keywords:    
data_footnote: 'Pensions not included in social benefits.  2010 to 2019: EU-28, from 2020: EU-27.   2014 to 2019 data estimated by Eurostat.  The "Living in Europe" survey (EU-SILC), previously conducted separately, was integrated into the microcensus as a sub-sample in 2020. Due to the change from a voluntary survey to a survey requiring information in some cases, combined with a new sample composition, it is not possible to compare the data for the 2020 survey year with previous years (break in time series).'    
