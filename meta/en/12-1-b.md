...
<div>
  <div class="my-header">
    <label class="default">bb) Energy consumption: steady reduction
      <a href="www.dnsTestEnvironment.github.io/dns-indicators/en/status"><img src="https://g205sdgs.github.io/sdg-indicators/public/Wettersymbole/Später.png" title="In 2018 both the average value and the previous annual change pointed in the right direction." alt="Weathersymbol: Später"/>
      </a>
    </label>
  </div>
</div>
...
<div class="my-header-note">
  <label class="default"><b>(Evaluations of the indicator report 2022 relating to the reporting year 2018)
  </b></label>
</div>